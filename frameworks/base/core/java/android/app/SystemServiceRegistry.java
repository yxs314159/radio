...
//add
import android.app.HQFMManager;
...
//add
        registerService(Context.HQFM_SERVICE, HQFMManager.class,
                new CachedServiceFetcher<HQFMManager>() {
            @Override
            public HQFMManager createService(ContextImpl ctx) {
	   	IBinder b = ServiceManager.getService(Context.HQFM_SERVICE);
		IHQFMService service = IHQFMService.Stub.asInterface(b);		
            return new HQFMManager(ctx, service);
            }});
    }
