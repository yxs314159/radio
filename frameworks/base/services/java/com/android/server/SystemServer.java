...
import com.android.server.HQFMService;
...
public final class SystemServer {
    ...
    private void startOtherServices() {
        ...
        VibratorService vibrator = null; //振动器
...
//            disableLocation = true;
	    ...
	    //----------------------------------------------
	   /*
	    Slog.i(TAG, "yangxuesong");
	   
	    Slog.d(TAG, "yangxuesong");

	*/
	    Slog.i(TAG, "yangxuesong...");
	
	    try{
        	    ServiceManager.addService(Context.HQFM_SERVICE, new HQFMService(context));	
	 
	    }catch(Throwable e){
		Slog.e(TAG, "failure starting HQFM SERvice",e);	
            }
	    ...
	    //---------------------------------------------------------------------		
            ...
            if(!isBox){
                ...
                vibrator = new VibratorService(context);//振动器的添加
	...
	/*       
	 try {
                  ...
                  ServiceManager.addService("HQFMService", new HQFMService());
